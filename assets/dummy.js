...
define('dummy/ember-world-flags/tests/addon.lint-test', [], function () {
  ...
  QUnit.test('ember-world-flags/helpers/world-flag-svg.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'ember-world-flags/helpers/world-flag-svg.js should pass ESLint\n\n');
  });
...
define('dummy/helpers/world-flag-svg', ['exports', 'ember-world-flags/helpers/world-flag-svg'], function (exports, _worldFlagSvg) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _worldFlagSvg.default;
});
